...
const amendments = [
  {
    id: 'amend16',
    track: 'amend', kind: 'amend16', color: COLOR_16,
  ...
  {
    id: 'amend17',
    track: 'amend', kind: 'amend17', color: COLOR_17, labelStagger: 1,
  ...
  {
    id: 'amend18',
    track: 'amend', kind: 'amend18', color: COLOR_18,
  ...
  {
    id: 'amend19',
    track: 'amend', kind: 'amend19', color: COLOR_19, labelStagger: 1,
...
function drawEventNode(ev) {
  ...
  let baseOffset = (ev.track === 'amend') ? -28 : 26;
  let labelOffset = baseOffset + (stagger ? (ev.track === 'amend' ? -16 : 16) : 0);
  ...
  let labelW = ev.track === 'amend' ? 130 : 110;
  let labelX = constrain(x - labelW / 2, margin + 2, canvasWidth - margin - labelW - 2);
