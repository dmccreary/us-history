...
function initializeNetwork() {
    ...
    // Allow page scroll when mouse wheel is used without Ctrl/Cmd.
    // vis-network captures all wheel events by default, which causes the
    // graph to pan sideways instead of the page scrolling.
