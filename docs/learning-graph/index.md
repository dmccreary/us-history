# Learning Graph for U.S. History
...
This U.S. History learning graph contains **450 concepts** organized into **15 thematic categories**
spanning pre-Columbian civilizations through the modern Age of AI, with **770 dependency edges**
and a maximum learning chain of 94 steps.
...
- Foundational concepts: 2 entry points (Pre-Columbian Civilizations; Historical Causation)
- Indegree distribution analysis
- Longest dependency chain: 94 steps
...
- 15 categories: 12 chronological periods + Foundation Concepts + AP Themes + Historical Thinking Skills
- Balanced categories ranging from 1.6% to 11.3% each
- All categories under the 30% threshold
- Chronological color coding from DarkGoldenrod (Period 1) through Orange (Age of AI)
